...
use App\Http\Requests\ServiceCatalogueRequest;
...
{
    /**
     * Display a listing of service catalogues owned by the provider's companies
     */
    public function index()
    {
        ...
        $catalogues = Catalogue::service()
            ...
            ->map(function ($catalogue) {
                return [
                    ...
                    'services_count' => $catalogue->services_count,
                    'company' => [
        ...
        return Inertia::render('Provider/ServiceCatalogues/Index', [
            'catalogues' => $catalogues,
        ]);
    }

    /**
     * Show the form for creating a new service catalogue
     */
    public function create()
    {
        ...
        return Inertia::render('Provider/ServiceCatalogues/Create', [
            'companies' => $companies,
        ]);
    }

    /**
     * Store a newly created service catalogue
     */
    public function store(ServiceCatalogueRequest $request)
    {
        $provider = Auth::user()->serviceProvider;
        ...
        return redirect()->route('provider.service-catalogues.index')
            ->with('success', 'Service catalogue created successfully');
    }

    /**
     * Show the form for editing the specified service catalogue
     */
    public function edit($id)
    {
        ...
        return Inertia::render('Provider/ServiceCatalogues/Edit', [
            'catalogue' => [
                'id' => $catalogue->id,
    ...
    /**
     * Update the specified service catalogue
     */
    public function update(ServiceCatalogueRequest $request, $id)
    {
        $provider = Auth::user()->serviceProvider;
        ...
        return redirect()->route('provider.service-catalogues.index')
            ->with('success', 'Service catalogue updated successfully');
    }

    /**
     * Remove the specified service catalogue
     */
    public function destroy($id)
    {
        ...
        return redirect()->route('provider.service-catalogues.index')
            ->with('success', 'Service catalogue deleted successfully');
    }
}
