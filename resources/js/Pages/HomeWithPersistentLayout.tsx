...
function HomeWithPersistentLayout({
  categories,
  featuredProviders,
  topProviders,
  lilongweProviders,
  ...
  return (
    <HeroCarouselProvider>
      ...
      />
      {/* Header and Footer are automatically handled by PersistentLayout */}
      <HeroFeatured />
...
// Wrap with PersistentLayout for automatic header/footer handling
export default withPersistentLayout(HomeWithPersistentLayout)