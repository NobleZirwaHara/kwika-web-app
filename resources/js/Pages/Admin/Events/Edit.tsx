...
export default function EventEdit({ admin, event, providers, categories, types }: Props) {
  const { data, setData, put, processing, errors } = useForm({
    service_provider_id: event.service_provider_id.toString(),
    title: event.title,
  ...
  return (
    <AdminLayout title="Edit Event" admin={admin}>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  {event.cover_image && (
                    <div className="mb-2">
                      <img src={event.cover_image} alt="Current cover" className="h-20 rounded" />
