...
export default function CompaniesCreate({ admin, providers }: Props) {
  ...
  return (
    <AdminLayout title="Create Company" admin={admin}>
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">Add a new corporate entity</p>
          </div>
        </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-2">
                  {coverPreview ? (
                    <div className="relative inline-block">
                      <img src={coverPreview} alt="Cover preview" className="w-full max-w-md h-48 object-cover rounded-lg border" />
                      <Button type="button" variant="destructive" size="sm" className="absolute top-2 right-2" onClick={removeCover}>
                        <X className="h-4 w-4" />
                      </Button>
                    </div>
                  ) : (
