              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {topOrganizers.map((organizer, index) => (
                  <motion.div
                    ...
                    transition={{ duration: 0.4, delay: index * 0.1 }}
                  >
                    <Card className="overflow-hidden bg-gray-900 border-gray-800 hover:border-primary/50 transition-all group cursor-pointer">
                      {/* Cover Image */}
                      ...
                      <CardContent className="p-4 relative">
                        {/* Logo */}
                        <div className="absolute -top-8 left-4 w-16 h-16 rounded-xl bg-gray-800 border-4 border-gray-900 overflow-hidden shadow-lg">
                          {organizer.logo ? (
