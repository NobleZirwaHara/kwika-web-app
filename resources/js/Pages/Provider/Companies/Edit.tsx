...
export default function EditCompany({ company }: Props) {
  ...
  const [coverPreview, setCoverPreview] = useState<string | null>(company.cover_image)
  ...
  const { data, setData, post, processing, errors } = useForm({
    ...
    city: company.city || '',
    state: company.state || '',
    country: company.country || 'Malawi',
  ...
  function handleSubmit(e: FormEvent) {
    e.preventDefault()
    post(`/provider/companies/${company.id}`)
  }

  return (
    <ProviderLayout title="Edit Company">
