...
export default function CreateServiceCatalogue({ companies }: Props) {
  ...
  function handleSubmit(e: FormEvent) {
    e.preventDefault()
    post('/provider/service-catalogues')
  }

  return (
    <ProviderLayout title="Create Service Catalogue">
      <Head title="Create Service Catalogue" />
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">Create Service Catalogue</h1>
            <p className="text-muted-foreground mt-1">
              Add a new catalogue to organize your services
            </p>
          </div>
        </div>
