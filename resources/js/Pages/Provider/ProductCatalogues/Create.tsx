...
import { Package, Upload, X, ArrowLeft, Building2 } from 'lucide-react'
...
export default function CreateProductCatalogue({ companies }: Props) {
  ...
  function handleSubmit(e: FormEvent) {
    e.preventDefault()
    post('/provider/product-catalogues')
  }

  return (
    <ProviderLayout title="Create Product Catalogue">
      <Head title="Create Product Catalogue" />

      <div className="space-y-6">
        {/* Header */}
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" asChild>
            <Link href="/provider/product-catalogues">
              <ArrowLeft className="h-5 w-5" />
            </Link>
          </Button>
          <div>
            <h1 className="text-3xl font-bold">Create Product Catalogue</h1>
            <p className="text-muted-foreground mt-1">
              Add a new catalogue to organize your products
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Essential details about your product catalogue
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g., Wedding Decor, Party Supplies"
                  required
                />
                {errors.name && (
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Add a cover image for your catalogue (max 5MB)
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {coverPreview ? (
          ...
          <div className="flex gap-4">
            ...
            <Button variant="outline" asChild>
              <Link href="/provider/product-catalogues">Cancel</Link>
            </Button>
          </div>
        </form>
      </div>
