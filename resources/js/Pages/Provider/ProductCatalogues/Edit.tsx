...
export default function EditProductCatalogue({ catalogue, companies }: Props) {
  ...
  function handleSubmit(e: FormEvent) {
    e.preventDefault()
    post(`/provider/product-catalogues/${catalogue.id}`)
  }

  return (
    <ProviderLayout title="Edit Product Catalogue">
      <Head title="Edit Product Catalogue" />
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">Edit Product Catalogue</h1>
            <p className="text-muted-foreground mt-1">
              Update your product catalogue details
            </p>
          </div>
        </div>
