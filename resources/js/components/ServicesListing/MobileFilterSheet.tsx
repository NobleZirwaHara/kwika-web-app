  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent side="bottom" className="h-[90vh]">
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-140px)] py-6">
          <Accordion type="multiple" defaultValue={["search", "category"]} className="w-full">
              ...
              <AccordionContent>
                ...
                >
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="" id="mobile-type-all" />
                    <label htmlFor="mobile-type-all" className="text-sm font-medium cursor-pointer">
                      All types
                    </label>
                  </div>
                  {priceTypeOptions.map((option) => (
                    <div key={option.value} className="flex items-center space-x-2">
                      <RadioGroupItem value={option.value} id={`mobile-type-${option.value}`} />
                      <label htmlFor={`mobile-type-${option.value}`} className="text-sm font-medium cursor-pointer">
                        {option.label}
                      </label>
                    </div>
                  ))}
            ...
            <AccordionItem value="date">
              <AccordionTrigger>Availability Date</AccordionTrigger>
              <AccordionContent>
                <Input
                  type="date"
