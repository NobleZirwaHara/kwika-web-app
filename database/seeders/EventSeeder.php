    ...
    public function run(): void
    {
        ...
        $events = [
            [
                ...
                'start_datetime' => Carbon::parse('2024-12-31 18:00:00'),
                'end_datetime' => Carbon::parse('2024-12-31 22:00:00'),
                'max_attendees' => 50000,
                'packages' => [
            ...
            [
                ...
                'start_datetime' => Carbon::parse('2025-01-15 19:00:00'),
                'end_datetime' => Carbon::parse('2025-01-15 23:00:00'),
                'max_attendees' => 2000,
                'packages' => [
            ...
            [
                ...
                'start_datetime' => Carbon::parse('2025-01-01 15:00:00'),
                'end_datetime' => Carbon::parse('2025-01-01 19:00:00'),
                'max_attendees' => 40000,
                'packages' => [
            ...
            [
                ...
                'start_datetime' => Carbon::parse('2025-02-14 18:00:00'),
                'end_datetime' => Carbon::parse('2025-02-14 23:00:00'),
                'max_attendees' => 300,
                'packages' => [
            ...
            [
                ...
                'start_datetime' => Carbon::parse('2025-09-27 12:00:00'),
                'end_datetime' => Carbon::parse('2025-09-29 23:00:00'),
                'max_attendees' => 10000,
                'packages' => [
            ...
            [
                ...
                'start_datetime' => Carbon::parse('2025-03-20 10:00:00'),
                'end_datetime' => Carbon::parse('2025-03-20 18:00:00'),
                'max_attendees' => 1000,
                'packages' => [
            ...
            [
                ...
                'start_datetime' => Carbon::parse('2025-04-10 19:00:00'),
                'end_datetime' => Carbon::parse('2025-04-10 23:00:00'),
                'max_attendees' => 200,
                'packages' => [
            ...
            [
                ...
                'start_datetime' => Carbon::parse('2025-06-15 15:00:00'),
                'end_datetime' => Carbon::parse('2025-06-15 17:30:00'),
                'max_attendees' => 60000,
                'packages' => [
